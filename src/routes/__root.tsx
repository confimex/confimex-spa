...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "CONFIMÉX — Patronaje Digital para Talleres de Confección en CDMX" },
      { name: "description", content: "Digitaliza los patrones de tu taller de confección. Diagnóstico GRATIS en CDMX. Ahorra hasta 40% en tela con tecnología de patronaje digital." },
      { name: "author", content: "CONFIMÉX" },
      { property: "og:title", content: "CONFIMÉX — Patronaje Digital para Talleres de Confección en CDMX" },
